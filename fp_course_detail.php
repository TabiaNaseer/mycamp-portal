...
<!-- Header Top ==== -->
    ...
    <div class="page-content bg-white">
        <!-- inner page banner -->
        <div class="page-banner ovbl-dark" style="background-image:url(assets/images/event/8pic.jfif);">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white">Fourth Professional PharmD</h1>
				 </div>
            </div>
        </div>
		<!-- Breadcrumb row -->
		<div class="breadcrumb-row">
			<div class="container">
				<ul class="list-inline">
					...
					<li>Fourth Professional PharmD</li>
				</ul>
			</div>
		</div>
		<!-- Breadcrumb row END -->
...
while($courses=mysqli_fetch_array($run4)){
  if($courses['type1']=='Fourth Professional PharmD'&& $courses['type2']=='First Semester'){
  ?>
...
$run4 = mysqli_query($db,$query4);;
while($courses=mysqli_fetch_array($run4)){
  if($courses['type1']=='Fourth Professional PharmD'&& $courses['type2']=='Second Semester'){
  ?>
                        <td style="color: black"><?=$courses['course_code']?></td>
                        <td style="color: black"><?=$courses['course_title']?></td>
                        <td style="color: black"><?=$courses['course_credit_hours']?></td>
