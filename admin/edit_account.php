...
<form role="form" action="update.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                 <div class="form-group col-6">
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="text"  class="form-control" value="<?php echo $faculty['my_name'] ?>"  name="name" >
                  </div>
                <div class="form-group col-6">
                    <label for="exampleInputEmail1">Desgnation</label>
                    <input type="text"  class="form-control" value="<?php echo $faculty['my_designation'] ?>" name="designation" required="">
                  </div>
                ...
                <div class="card-footer">
                  <button type="submit" name="update-account" class="btn btn-success">Update</button>
                </div>
              </form>
