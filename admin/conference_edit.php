        ...
        <div class="row">
          <div class="card card-success col-lg-12">
              ...
              <?php
                ...
                {
                  $id=$_POST['edit_con_id'];

                  $query="SELECT * FROM conference WHERE id='$id' ";
                  $query_run=mysqli_query($db,$query);

                  foreach($query_run as $conference)
                  {
?>
...
<form role="form" action="update.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group col-6">
                     <img src="../assets/images/event/<?=$conference['con_pic']?>" class="col-2">
                    <label for="exampleInputEmail1">Picture</label>
                    <input type="file"  class="form-control" value="<?php echo $conference['con_pic'] ?>" name="profile" >
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">Title</label>
                    <input type="text"  class="form-control" value="<?php echo $conference['con_title'] ?>"  name="title" >
                  </div>
                <div class="form-group col-6">
                    <label for="exampleInputEmail1">Venue</label>
                    <input type="text"  class="form-control" value="<?php echo $conference['con_desc'] ?>" name="desc" required="">
                  </div>
                ...
                <div class="card-footer">
                  <a href="../admin/admin.php?conferencesetting=true " class="btn btn-secondary"> Cancel </a>
                  <button type="submit" name="update-conference" class="btn btn-success">Update</button>
                </div>
              </form>
