								...
								<div class="tab-content">
									<div class="tab-pane active" id="courses">
										<div class="profile-head">
											<i><h3>Department of Pharmaceutical-Chemistry</h3></i>
...
while($faculty=mysqli_fetch_array($run1)){
  ...
  ?>
          ...
          ?>
										...
										<div class="profile-head">
											<i><h3>Department of Pharmaceutics</h3></i>
...
while($faculty=mysqli_fetch_array($run1)){
  ...
  ?>
          ...
          ?>
										...
										<div class="profile-head">
											<i><h3>Department of Pharmacognosy</h3></i>
...
<div class="profile-head">
											<i><h3>Department of Pharmacology</h3></i>
...
while($faculty=mysqli_fetch_array($run1)){
  ...
  ?>
          ...
          ?>
										...
										<div class="profile-head">
											<i><h3>Department of Pharmacy-Practice</h3></i>
                ...
                <div class="row">
					<div class="col-lg-4 col-md-12 col-sm-12 footer-col-4">
                        <div class="widget">
							...
							<p class="text-capitalize m-b20">Our students competes the contemporary challenges along with serving the customary roles of pharmacist to promote and protect the health care system by appropriate utilization of the key tools as education communication, licensing, regulation and enforcement provided to them.</p>
