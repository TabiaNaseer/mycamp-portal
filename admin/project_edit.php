...
<form role="form" action="update.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group col-6">
                     <img src="../assets/images/event/<?=$project['p_pic']?>" class="col-2">
                    <label for="exampleInputEmail1">Picture</label>
                    <input type="file"  class="form-control" value="<?php echo $project['p_pic']?>" name="profile" >
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">Title</label>
                    <input type="text" class="form-control" value="<?php echo $project['p_title']?>"  name="title" required="">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">Start Date</label>
                    <input type="text" class="form-control" value="<?php echo $project['p_date']?>" name="date" id="exampleInputEmail1" required="">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">End Date</label>
                    <input type="text" class="form-control" value="<?php echo $project['pe_date']?>" name="edate" id="exampleInputEmail1" required="">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">Name of PI</label>
                    <input type="text" class="form-control" value="<?php echo $project['pi_name']?>" name="author" id="exampleInputEmail1" required="">
                  </div>
                 
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1"> Current Progress</label>
                    <input type="text" class="form-control" value="<?php echo $project['p_status']?>"  name="desc" id="exampleInputEmail1" required="">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">Status</label><br>
                  <select name="status" value="<?php echo $project['status']?>" class="form-control">
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control"  name="description" value="<?php echo $project['description']?>" id="exampleInputEmail1" required="">
                  </div>
                   <div class="form-group col-6">
                    <label for="exampleInputEmail1">Product Name</label>
                    <input type="text" class="form-control"  name="p_name" value="<?php echo $project['pro_name']?>" id="exampleInputEmail1" required="">
                  </div>
                   <div class="form-group col-6">
                    <label for="exampleInputEmail1">Field of Research</label>
                    <input type="text" class="form-control" value="<?php echo $project['f_o_res']?>" name="f_res" id="exampleInputEmail1" required="">
                  </div>
                   <div class="form-group col-6">
                    <label for="exampleInputEmail1">Funding Agency</label>
                    <input type="text" class="form-control"  value="<?php echo $project['funding_agency']?>"name="fun_age" id="exampleInputEmail1" required="">
                  </div>
                ...
                <div class="card-footer">
                  <a href="../admin/admin.php?projectsetting=true " class="btn btn-secondary"> Cancel </a>
                  <button type="submit" name="update-project" class="btn btn-success">Update</button>
                </div>
              </form>
