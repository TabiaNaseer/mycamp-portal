...
<form role="form" action="update.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="text"  required="" class="form-control" value="<?php echo $pi['course_code'] ?>"  name="cc" >
                  </div>
                <div class="form-group col-6">
                    <label for="exampleInputEmail1">Title</label>
                    <input type="text"  class="form-control" value="<?php echo $pi['course_title'] ?>" name="title" required="">
                  </div>
                  
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">Credit Hours</label>
                    <input type="text" class="form-control" value="<?php echo $pi['course_credit_hours'] ?>" name="crehr" id="exampleInputEmail1" required="">
                  </div>
                ...
                <div class="card-footer">
                  <a href="../admin/admin.php?coursesetting=true " class="btn btn-secondary"> Cancel </a>
                  <button type="submit" name="update-course" class="btn btn-success">Update</button>
                </div>
              </form>
