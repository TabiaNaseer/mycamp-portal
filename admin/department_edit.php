...
<form role="form" action="update.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="text"  class="form-control" value="<?php echo $department['departmentname'] ?>"  name="name" >
                  </div>
                ...
                <div class="card-footer">
                  <a href="../admin/admin.php?departmentsetting=true " class="btn btn-secondary"> Cancel </a>
                  <button type="submit" name="update-department" class="btn btn-success">Update</button>
                </div>
              </form>
