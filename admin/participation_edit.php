        ...
        <div class="row">
          <div class="card card-success col-lg-12">
              <div class="card-header">
                <h3 class="card-title">Update Participation</h3>
              </div>
              <br>
              <?php
                if(isset($_POST['edit_data_btn']))
                {
                  $id=$_POST['edit_part_id'];

                  $query="SELECT * FROM participation WHERE id='$id' ";
                  $query_run=mysqli_query($db,$query);

                  foreach($query_run as $participation)
                  {
?>
...
<form role="form" action="update.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group col-6">
                     <img src="../assets/images/event/<?=$participation['par_pic']?>" class="col-2">
                    <label for="exampleInputEmail1">Picture</label>
                    <input type="file"  class="form-control" value="<?php echo $participation['par_pic'] ?>" name="profile" >
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">Title</label>
                    <input type="text"  class="form-control" value="<?php echo $participation['par_title'] ?>"  name="title" >
                  </div>
                <div class="form-group col-6">
                    <label for="exampleInputEmail1">Venue</label>
                    <input type="text"  class="form-control" value="<?php echo $participation['par_desc'] ?>" name="desc" required="">
                  </div>
                ...
                <div class="card-footer">
                  <a href="../admin/admin.php?participationsetting=true " class="btn btn-secondary"> Cancel </a>
                  <button type="submit" name="update-participation" class="btn btn-success">Update</button>
                </div>
              </form>
