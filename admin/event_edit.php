...
<form role="form" action="update.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group col-6">
                     <img src="../assets/images/event/<?=$event['event_pic']?>" class="col-2">
                    <label for="exampleInputEmail1">Picture</label>
                    <input type="file"  class="form-control" value="<?php echo $event['event_pic'] ?>" name="profile" >
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">Title</label>
                    <input type="text"  class="form-control" value="<?php echo $event['event_title'] ?>"  name="title" >
                  </div>
                <div class="form-group col-6">
                    <label for="exampleInputEmail1">Venue</label>
                    <input type="text"  class="form-control" value="<?php echo $event['event_date'] ?>" name="date" required="">
                  </div>
                  
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">Organizer</label>
                    <input type="text" class="form-control" value="<?php echo $event['event_time'] ?>" name="time" id="exampleInputEmail1" required="">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">Date</label>
                    <input type="date" class="form-control" value="<?php echo $event['event_date2'] ?>" name="date2" id="exampleInputEmail1" required="">
                  </div>
                ...
                <div class="card-footer">
                  <a href="../admin/admin.php?eventsetting=true " class="btn btn-secondary"> Cancel </a>
                  <button type="submit" name="update-event" class="btn btn-success">Update</button>
                </div>
              </form>
