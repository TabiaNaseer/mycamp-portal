          ...
          <div class="card card-success col-lg-12">
              ...
              <?php
                if(isset($_POST['edit_data_btn']))
                {
                  ...
                  foreach($query_run as $achievement)
                  {
?>
...
<form role="form" action="update.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group col-6">
                     <img src="../assets/images/event/<?=$achievement['ac_pic']?>" class="col-2">
                    <label for="exampleInputEmail1">Picture</label>
                    <input type="file"  class="form-control" value="<?php echo $achievement['ac_pic'] ?>" name="profile" >
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">Title</label>
                    <input type="text"  class="form-control" value="<?php echo $achievement['ac_title'] ?>"  name="title" >
                  </div>
                <div class="form-group col-6">
                    <label for="exampleInputEmail1">Venue</label>
                    <input type="text"  class="form-control" value="<?php echo $achievement['ac_desc'] ?>" name="desc" required="">
                  </div>
                ...
                <div class="card-footer">
                  <a href="../admin/admin.php?achievementsetting=true " class="btn btn-secondary"> Cancel </a>
                  <button type="submit" name="update-achievement" class="btn btn-success">Update</button>
                </div>
              </form>
