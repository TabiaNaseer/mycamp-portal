...
<form role="form" action="update.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-6">
                    ...
                    <textarea cols="500" type="text" class="form-control"  name="news" required="" ><?=$news['newsdata'] ?></textarea>
                  </div>
                ...
                <div class="card-footer">
                  <a href="../admin/admin.php?newssetting=true " class="btn btn-secondary"> Cancel </a>
                  <button type="submit" name="update-news" class="btn btn-success">Update</button>
                </div>
              </form>
