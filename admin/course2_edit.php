          ...
          <div class="card card-success col-lg-12">
              ...
              <?php
                if(isset($_POST['edit_data_btn']))
                {
                  ...
                  $query="SELECT * FROM courses2 WHERE id='$id' ";
                  $query_run=mysqli_query($db,$query);
...
<form role="form" action="update.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="text"  required="" class="form-control" value="<?php echo $pi['course_code2'] ?>"  name="cc" >
                  </div>
                <div class="form-group col-6">
                    <label for="exampleInputEmail1">Title</label>
                    <input type="text"  class="form-control" value="<?php echo $pi['course_title2'] ?>" name="title" required="">
                  </div>
                  
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">Credit Hours</label>
                    <input type="text" class="form-control" value="<?php echo $pi['course_credit_hours2'] ?>" name="crehr" id="exampleInputEmail1" required="">
                  </div>
                ...
                <div class="card-footer">
                  <a href="../admin/admin.php?phdcoursesetting=true " class="btn btn-secondary"> Cancel </a>
                  <button type="submit" name="update-course2" class="btn btn-success">Update</button>
                </div>
              </form>
