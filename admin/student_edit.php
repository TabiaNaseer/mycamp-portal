...
<form role="form" action="update.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="text"  class="form-control" value="<?php echo $student['firstname'] ?>"  name="name" >
                  </div>
                <div class="form-group col-6">
                    <label for="exampleInputEmail1">Last Name</label>
                    <input type="text"  class="form-control" value="<?php echo $student['lastname'] ?>" name="lname" required="">
                  </div>
                  
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">Start Date</label>
                    <input type="text" class="form-control" value="<?php echo $student['startdate'] ?>" name="sdate" id="exampleInputEmail1" required="">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">Student id</label>
                    <input type="text" class="form-control" value="<?php echo $student['username'] ?>" name="sid" id="exampleInputEmail1" required="">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">Password</label>
                    <input type="text" class="form-control" value="<?php echo $student['password'] ?>" name="spass" id="exampleInputEmail1" required="">
                  </div>
                ...
                <div class="card-footer">
                  <a href="../admin/admin.php?studentsetting=true " class="btn btn-secondary"> Cancel </a>
                  <button type="submit" name="update-student" class="btn btn-success">Update</button>
                </div>
              </form>
