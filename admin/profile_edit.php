  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="index.php?profilesetting" class="d-block"> <?php echo  $faculty['my_name'];?></a>
        </div>
      </div>
...
<form role="form" action="update.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control" value="<?php echo $pi['education']?>"  name="edu">
                    
                  </div>
                <div class="form-group col-6">
                    <label for="exampleInputEmail1">Department</label>
                    <input type="text" class="form-control"  name="dep" value="<?php echo $pi['dep']?>" id="exampleInputEmail1">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">University</label>
                    <input type="text" class="form-control"  name="uni"value="<?php echo $pi['uni']?>" id="exampleInputEmail1">
                  </div>
                ...
                <div class="card-footer">
                  <a href="../admin/index.php?profilesetting=true " class="btn btn-secondary"> Cancel </a>
