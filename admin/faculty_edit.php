...
$faculty = mysqli_fetch_array($run);
?>
...
<form role="form" action="update.php" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  <div class="form-group col-6">
                     <img src="../assets/images/testimonials/<?=$faculty['my_prof_pic']?>" class="col-2">
                    <label for="exampleInputEmail1">Picture</label>
                    <input type="file"   class="form-control" value="<?php echo $faculty['my_prof_pic'] ?>" name="profile" >
                  </div>
                  
                <div class="form-group col-6">
                    <label for="exampleInputEmail1">Name</label>
                    <input type="text"  class="form-control" value="<?php echo $faculty['my_name'] ?>" name="title" required="">
                  </div>
                  <div class="form-group col-6">
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="text" class="form-control" value="<?php echo $faculty['education'] ?>"  name="edu" id="exampleInputEmail1" required="">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">Qualifying Department</label>
                    <input type="text" class="form-control" value="<?php echo $faculty['dep'] ?>"  name="department" id="exampleInputEmail1" required="">
                  </div>
                  <div class="form-group col-6">
                    <label for="exampleInputEmail1">University</label>
                    <input type="text" class="form-control" value="<?php echo $faculty['uni'] ?>"  name="uni" id="exampleInputEmail1" required="">
                  </div>
                  <div class="form-group col-6">
                    ...
                    <select name="dep" class="form-control">
                      ...
                      <option value="Department of Pharmacognosy">Department of Pharmacognosy</option>
                 ...
                 <div class="form-group col-6">
                    ...
                    <select name="author" class="form-control">
                      ...
                      <option value="Co-operative Lecturer">Co-operative Lecturer</option>
                ...
                <div class="card-footer">
                  <a href="../admin/admin.php?facultysetting=true " class="btn btn-secondary"> Cancel </a>
                  <button type="submit" name="update-faculty" class="btn btn-success">Update</button>
                </div>
              </form>
