...
<!-- Header Top ==== -->
    ...
    <div class="page-content bg-white">
        <!-- inner page banner -->
        <div class="page-banner ovbl-dark" style="background-image:url(assets/images/event/2pic.jfif);">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white">Pharmacology Curriculum</h1>
				 </div>
            </div>
        </div>
		<!-- Breadcrumb row -->
...
while($courses=mysqli_fetch_array($run4)){
  if($courses['type11']=='Pharmacology Curriculum'&& $courses['type22']=='First Semester'){
  ?>
...
$run4 = mysqli_query($db,$query4);;
while($courses=mysqli_fetch_array($run4)){
  if($courses['type11']=='Pharmacology Curriculum'&& $courses['type22']=='Second Semester'){
  ?>
                        <td style="color: black"><?=$courses['course_code1']?></td>
                        <td style="color: black"><?=$courses['course_title1']?></td>
                        <td style="color: black"> <?=$courses['course_credit_hours1']?></td>
