        ...
        <div class="page-banner ovbl-dark" style="background-image:url(assets/images/event/2pic.jfif);">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white">Fifth Professional PharmD</h1>
				 </div>
            </div>
        </div>
		<!-- Breadcrumb row -->
		<div class="breadcrumb-row">
			<div class="container">
				<ul class="list-inline">
					...
					<li>Fifth Professional PharmD</li>
				</ul>
			</div>
		</div>
		<!-- Breadcrumb row END -->
...
while($courses=mysqli_fetch_array($run4)){
  if($courses['type1']=='Fifth Professional PharmD'&& $courses['type2']=='First Semester'){
  ?>
...
$run4 = mysqli_query($db,$query4);;
while($courses=mysqli_fetch_array($run4)){
  if($courses['type1']=='Fifth Professional PharmD'&& $courses['type2']=='Second Semester'){
  ?>
                        <td style="color: black"><?=$courses['course_code']?></td>
                        <td style="color: black"><?=$courses['course_title']?></td>
                        <td style="color: black"><?=$courses['course_credit_hours']?></td>
