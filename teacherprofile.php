...
$query = "SELECT * FROM resume,personal_info,aboutme , faculty";
					 ...
					 <div class="row">
						<div class="col-lg-3 col-md-4 col-sm-12 m-b30">
							<div class="profile-bx text-center">
								<?php
														$post_id=$_GET['id'];
$query2 = "SELECT * FROM faculty WHERE id=$post_id";
$run2 = mysqli_query($db,$query2);

while($faculty = mysqli_fetch_array($run2)){
  ?>
...
?>
								...
								<div class="profile-tabnav">
									<ul class="nav nav-tabs">
										<li class="nav-item">
											<a class="nav-link active" data-toggle="tab" href="#about"><i class="fa fa-info-circle"></i>About </a>
										</li>
										<li class="nav-item">
											<a class="nav-link" data-toggle="tab" href="#research"><i class="fa fa-pencil-square-o"></i>Researches</a>
										</li>
										
										
										<li class="nav-item">
											<a class="nav-link" data-toggle="tab" href="#honor"><i class="fa fa-trophy"></i>Honors and Awards</a>
										</li>
									</ul>
								</div>
							</div>
						...
						<div class="col-lg-9 col-md-8 col-sm-12 m-b30">
							<div class="profile-content-bx" style="width: 100%">
											...
											<div class="row">
												...
												<div class="col-md-6 col-lg-12">
													<ul class="course-features">
														...
														<?php
														$post_id=$_GET['id'];
$query2 = "SELECT * FROM qualification WHERE fac_id=$post_id";
$run2 = mysqli_query($db,$query2);

while($faculty = mysqli_fetch_array($run2)){
  ?>

														<li><i class="fa fa-genderless"></i> <span class="label" style="color: black"><?=$faculty['education']?>&nbsp;(<?=$faculty['dep']?>)&nbsp;<?=$faculty['uni']?></span></li>
...
while($faculty = mysqli_fetch_array($run2)){
  ?>
														...
														<li class="label" style="color: black"><i class="fa fa-genderless"></i><?=$faculty['profile']?></li>
...
$query4 = "SELECT * FROM resume WHERE faculty_id=$post_id";


$run4 = mysqli_query($db,$query4);;
while($resume=mysqli_fetch_array($run4)){
  if($resume['type']=='Researches'){
  ?>
													<ul class="course-features">
														
														<li style="color: black"><i class="fa fa-genderless"></i><?=$resume['description']?></li>
														<?php
