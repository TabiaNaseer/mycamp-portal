				...
				<div class="container" >
					<div class="ttr-blog-grid-3 row" >
						...
						<div class="tab-pane "  id="publication" >
										<div class="profile-head"style=" background-color: #082567">
											<h3 style="color: white">Journal Publications</h3>
										</div>
...
$offset = ($page -1) * $limit;
$query1 = "SELECT * FROM research ORDER BY res_year DESC LIMIT {$offset},{$limit}";
$run1 = mysqli_query($db,$query1);;
while($research=mysqli_fetch_array($run1)){
 ?>
													<ul class="course-features" >
														
														<li style="color: black; "><i class="fa fa-genderless"></i>
															


															<?=$research['res_title']?>&nbsp<a href="<?=$research['res_link']?>" target="_blank" style="color:blue" >(View)</a></li>
