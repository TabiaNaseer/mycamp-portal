                ...
                <div class="row">
					...
					<div  class="col-lg-5 col-md-5 m-b30">
						<div class="bg-primary text-white contact-info-bx">
							...
							<div class="widget widget_getintuch">	
								<ul>
									<li><i class="ti-location-pin"></i><?=$user_data['address']?></li>
									<li><i class="ti-mobile"></i><?=$user_data['phone_no']?>&nbsp; EXT (214)<br>(24/7 Support Line)</li>
									<li><i class="ti-email"></i><?=$user_data['email_add']?></li>
								</ul>
							</div>
					...
					<div  class="col-lg-7 col-md-7">
						<form class="contact-bx ajax-form" action="http://educhamp.themetrades.com/demo/assets/script/contact.php">
							<iframe class="square" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14472.819398415419!2d67.0298877!3d24.9250905!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x7d44a810d3040989!2sJinnah%20University%20For%20Women!5e0!3m2!1sen!2s!4v1627315348788!5m2!1sen!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
						</form>
					</div>
				</div>
            </div>
