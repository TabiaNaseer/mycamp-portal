        ...
        <div class="page-banner ovbl-dark" style="background-image:url(assets/images/event/6pic.jfif);">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white">Pharmacy Practice Curriculum</h1>
				 </div>
            </div>
        </div>
		<!-- Breadcrumb row -->
		<div class="breadcrumb-row">
			<div class="container">
				<ul class="list-inline">
					...
					<li>Pharmacy Practice Curriculum</li>
				</ul>
			</div>
		</div>
		<!-- Breadcrumb row END -->
...
while($courses=mysqli_fetch_array($run4)){
  if($courses['type11']=='Pharmacy Practice Curriculum'&& $courses['type22']=='First Semester'){
  ?>
...
$run4 = mysqli_query($db,$query4);;
while($courses=mysqli_fetch_array($run4)){
  if($courses['type11']=='Pharmacy Practice Curriculum'&& $courses['type22']=='Second Semester'){
  ?>
                        <td style="color: black"><?=$courses['course_code1']?></td>
                        <td style="color: black"><?=$courses['course_title1']?></td>
                        <td style="color: black"> <?=$courses['course_credit_hours1']?></td>
