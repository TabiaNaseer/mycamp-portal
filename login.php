		...
		<div class="account-form-inner">
			<div class="account-container">
				...
				<?php
                  ...
                  ?>
                  <?php
                  if (isset($_GET['msg'])) echo '<h5 style="color: green">'. $_GET['msg'].'</h5>';
                  if (isset($_GET['msg1'])) echo '<h5 style="color: red">'. $_GET['msg1'].'</h5>';
                   ?>

				<form class="contact-bx" action="include/admin.php" method="post" enctype="multipart/form-data">
  ...
  z-index: 2;
							...
							<div class="form-group">
								<div class="input-group"> 
									...
									<input type="password" id="password-field3"  class="form-control" title="Wrong Username or Password"   name="pass" id="exampleInputEmail1" required="">
                     <span toggle="#password-field3" class="fa fa-fw fa-eye-slash field-icon toggle-password3"></span>
								</div>
							</div>
						</div>
						<div class="col-lg-12">
						...
						<div class="col-lg-12 m-b30">
							<button name="login_button" type="submit" value="Submit" class="btn button-md">Login</button>
						</div>
