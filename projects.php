...
while($project=mysqli_fetch_array($run1)){
 ?>
						<a href="blog-details.php?id=<?=$project['id']?> "><div class=" action-card col-lg-4 col-md-6 col-sm-12 col-xs-12 m-b40">
							
							<div class="recent-news">
								
								<div class="action-box">
									<img src="assets/images/event/<?=$project['p_pic']?>" style=" height: 200px" alt="">
								</div>
								<style >
								.truncate {
										  width: 300px;
								...
								<div class="info-bx" style=" height: 200px">
									<ul class="media-post">
										
										<li><a href="#"><i class="fa fa-user"> Name of PI: </i><?=$project['pi_name']?></a></li>
									</ul>
									<h5 class="post-title truncate"><?=$project['p_title']?></h5>
									<p class="truncate"><i>Current Progress: <?=$project['p_status']?></i></p> 
	...
	$(".readmore-btn").on('click',function(){
		...
		$(this).text(replaceText);
					...
					if (mysqli_num_rows($result1)>0){
						...
						if($page > 1){
						echo '<li class="previous"><a href="projects.php?page='.($page-1).'" ><i class="ti-arrow-left"></i>Prev</a></li>';
					}
						for($i =1; $i<=$total_page; $i++){
							...
							echo '<li class = "'.$active.'"><a href="projects.php?page='.$i.'">'.$i.'</a></li>';


						}
						if($total_page > $page){
						echo '<li  class="next"><a href="projects?page='.($page+1).'" >Next <i class="ti-arrow-right"></i></a></li>';
				}
						echo'</ul>';
					}
