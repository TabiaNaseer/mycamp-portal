...
while($event=mysqli_fetch_array($run1)){
 ?>
							<li class="action-card col-lg-6 col-md-6 col-sm-12 m-b40"  >
								<div class="event-bx m-b30"  >
									<div class="action-box" >
										<img src="assets/images/event/<?=$event['event_pic']?>" style=" height: 300px"alt="">
									</div>
									<div class="info-bx d-flex" style=" height: 230px">
										
										<div>
											<div class="event-time" >
												<div class="event-info"><?=$event['event_date']?></div>
										...
										<div class="event-info">
											...
											<ul class="media-post">
												<li><i class="fa fa-user"></i>  &nbsp Organizer: <?=$event['event_time']?></li>
