...
<div id="loading-icon-bx"></div>
    ...
    <div class="page-content bg-white">
        <!-- inner page banner -->
        <div class="page-banner ovbl-dark" style="background-image:url(assets/images/event/9pic.jfif);">
            <div class="container">
                <div class="page-banner-entry">
                    <h1 class="text-white">Scheme of Course for MPhil</h1>
				 </div>
            </div>
        </div>
		<!-- Breadcrumb row -->
                ...
                <div class="container">
							<div class="row">
								<div class="col-md-6 col-lg-4 col-sm-6 m-b30">
									<div class="cours-bx">
										<div style="height:300px" class="action-box">
											<img src="assets/images/event/book.jpg" alt="">
											<a href="pc_courses.php" class="btn">Read More</a>
										</div>
										<div class="info-bx text-center">
											<h5><a href="pc_courses.php">Pharmacognosy Curriculum </a></h5>
											<span>Course</span>
										</div>
								...
								<div class="col-md-6 col-lg-4 col-sm-6 m-b30">
									<div class="cours-bx">
										<div style="height:300px" class="action-box">
											<img src="assets/images/event/book.jpg" alt="">
											<a href="pc2_courses.php" class="btn">Read More</a>
										</div>
										<div class="info-bx text-center">
											<h5><a href="pc2_courses.php">Pharmacology Curriculum</a></h5>
											<span>Course</span>
										</div>
								...
								<div class="col-md-6 col-lg-4 col-sm-6 m-b30">
									<div class="cours-bx">
										<div style="height:300px"  class="action-box">
											<img src="assets/images/event/book.jpg" alt="">
											<a href="pc3_courses.php" class="btn">Read More</a>
										</div>
										<div class="info-bx text-center">
											<h5><a href="pc3_courses.php">Pharmaceutics Curriculum</a></h5>
											<span>Course</span>
										</div>
									</div>
								</div>
								<div class="col-md-6 col-lg-4 col-sm-6 m-b30">
									<div class="cours-bx">
										<div style="height:300px"  class="action-box">
											<img src="assets/images/event/book.jpg" alt="">
											<a href="pc4_courses.php" class="btn">Read More</a>
										</div>
										<div style="height:90px" class="info-bx text-center">
											<h5><a href="pc4_courses.php">Pharmaceutical Chemistry Curriculum</a></h5>
											<span>Course</span>
										</div>
								...
								<div class="col-md-6 col-lg-4 col-sm-6 m-b30">
									<div class="cours-bx">
										<div style="height:300px" class="action-box">
											<img src="assets/images/event/book.jpg" alt="">
											<a href="pc5_courses.php" class="btn">Read More</a>
										</div>
										<div style="height:90px" class="info-bx text-center">
											<h5><a href="pc5_courses.php">Pharmacy Practice Curriculum </a></h5>
											<span>Course</span>
										</div>
